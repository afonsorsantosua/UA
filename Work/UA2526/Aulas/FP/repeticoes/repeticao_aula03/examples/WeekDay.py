...
Version with function definitions.
Start by reading the main function and try to understand _what_ it does.
Then take a look inside each function to understand the details.
...
# A different way to do it (from somewhere on the internet...)
